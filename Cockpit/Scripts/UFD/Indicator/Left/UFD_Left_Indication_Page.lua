...
-- ========== Choose page ==========
addUFDSimple("Menu_Base", nil, nil, base, nil, nil, {"leftUFDPage"}, {{ctrl.compareNum, 0, 0}})
...
-- ========== WARN page ==========
addUFDSimple("WARN_Base", nil, nil, base, nil, nil, {"leftUFDPage"}, {{ctrl.compareNum, 0, 1}})
...
light = 0
lights = {
	{text = "OIL PRES",               param = {"leftOilPRESWARN"},   color = materials["red"]},
	{text = "ENG FIRE",               param = {"leftENGFireWARN"},   color = materials["red"]},
	{text = " WARNING",               param = {"generalWARN"},       color = materials["red"]},
	{text = " GEN: 1 ",               param = {"GEN1Caution"},       color = materials["orange"]},
	{text = " HYD: 1 ",               param = {"HYD1Caution"},       color = materials["orange"]},
	{text = " BEACON ",               param = {"beaconLights"},      color = materials["green"]},
	{text = "FORM LTS",               param = {"formationLights"},   color = materials["green"]},
	{text = "POSI LTS",               param = {"positionLights"},    color = materials["green"]},
	{text = {"TAXI LTS", "LAND LTS"}, param = {"taxiLandingLights"}, color = {materials["green"], materials["green"]}}
}
