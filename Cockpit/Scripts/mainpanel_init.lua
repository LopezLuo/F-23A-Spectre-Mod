...
-- ==============================================================================
--              This is all Raptor Mod stuff and will have to be replaced
-- ==============================================================================

local controllers = LoRegisterPanelControls()

GearHandle                = CreateGauge("parameter") -- First F-23 Entry
GearHandle.arg_number     = 1003
GearHandle.input          = {0, 1}
GearHandle.output         = {1, 0}
GearHandle.parameter_name = "GEAR_LEVER"

BackLighting                = CreateGauge("parameter")
BackLighting.arg_number     = 756
BackLighting.input          = {0, 1}
BackLighting.output         = {0, 1}
BackLighting.parameter_name = "BACK_LIGHTING"

FloodLighting                = CreateGauge("parameter")
FloodLighting.arg_number     = 755
FloodLighting.input          = {0, 1}
FloodLighting.output         = {0, 1}
FloodLighting.parameter_name = "FLOOD_LIGHTING"

GearNoseLight                = CreateGauge("parameter")
GearNoseLight.arg_number     = 757
GearNoseLight.input          = {0, 1}
GearNoseLight.output         = {0, 1}
GearNoseLight.parameter_name = "NOSE_GEAR_LIGHT"

GearRightLight                = CreateGauge("parameter")
GearRightLight.arg_number     = 758
GearRightLight.input          = {0, 1}
GearRightLight.output         = {0, 1}
GearRightLight.parameter_name = "LEFT_GEAR_LIGHT"

GearRightLight                = CreateGauge("parameter") -- Latest F-23 Entry
GearRightLight.arg_number     = 759
GearRightLight.input          = {0, 1}
GearRightLight.output         = {0, 1}
GearRightLight.parameter_name = "RIGHT_GEAR_LIGHT"

ThrottleLeft            = CreateGauge()
ThrottleLeft.arg_number = 768
...
ThrottleRight.arg_number = 766
ThrottleRight.input      = {0, 1}
ThrottleRight.output     = {1, -1}
ThrottleRight.controller = controllers.base_gauge_ThrottleRightPosition

ThrottleLeftCut                = CreateGauge("parameter")
ThrottleLeftCut.arg_number     = 767
ThrottleLeftCut.input          = {0, 1}
ThrottleLeftCut.output         = {-1, 1}
ThrottleLeftCut.parameter_name = "LEFT_THROTTLE_CUTOFF"

ThrottleRightCut                = CreateGauge("parameter")
ThrottleRightCut.arg_number     = 765
ThrottleRightCut.input          = {0, 1}
ThrottleRightCut.output         = {-1, 1}
ThrottleRightCut.parameter_name = "RIGHT_THROTTLE_CUTOFF"
