...
--- @param obj table: The element to set properties for.
...
--- @return Element: The element with the set properties.
...
--- Copies an element and changes its properties based on the provided parameters.
--- @param obj table: The element to copy.
...
--- @return table: The copied element with the changed properties.
...
function addSimple(name, pos, rot, parentElement, hClip, level, elementParams, controllers)
	local simple = CreateElement "ceSimple"
	setCommonProperties(simple, name, pos, rot, parentElement, hClip, level, elementParams, controllers)
...
function addMeshPoly(name, pos, rot, parentElement, hClip, level, elementParams, controllers, vertices, indices, material, isMask)
	...
	meshPoly.material      = material or materials["primary"]
	setCommonProperties(meshPoly, name, pos, rot, parentElement, hClip, level, elementParams, controllers, isMask)
...
function addCircle(name, pos, rot, parentElement, hClip, level, elementParams, controllers, outerRadius, innerRadius, arc, res, material, isMask)
	local circle = {}
	set_circle(circle, outerRadius, innerRadius, arc, res)

	return addMeshPoly(name, pos, rot, parentElement, hClip, level, elementParams, controllers, circle.vertices, circle.indices, material, isMask)
end
...
function addSimpleLine(name, pos, rot, parentElement, hClip, level, elementParams, controllers, width, vertices, material, isMask)
	local simpleLine    = CreateElement "ceSimpleLineObject"
	simpleLine.width    = width
	simpleLine.vertices = vertices or {{0}, {0}}
	simpleLine.material = material or materials["primary"]
	setCommonProperties(simpleLine, name, pos, rot, parentElement, hClip, level, elementParams, controllers, isMask)
...
function addBox(name, pos, rot, parentElement, hClip, level, elementParams, controllers, width, height, material, isMask)
	local vertices = {{0, height / 2}, {0, -height / 2}}

	return addSimpleLine(name, pos, rot, parentElement, hClip, level, elementParams, controllers, width / 2, vertices, material, isMask)
end
...
function addText(name, pos, rot, parentElement, hClip, level, elementParams, controllers, text, alignment, stringdef, font)
	...
	setCommonProperties(textObj, name, pos, rot, parentElement, hClip, level, elementParams, controllers)
...
--- @param font string The font to use for the text (default is fonts["white"]).
--- @return table The created "ceStringPoly" element.
function addTextParam(name, pos, rot, parentElement, hClip, level, elementParams, controllers, textParam, alignment, format, stringdef, font)
